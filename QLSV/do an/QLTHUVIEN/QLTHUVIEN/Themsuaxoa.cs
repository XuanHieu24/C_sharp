...
namespace WindowsFormsApplication1
{
    class Themsuaxoa
    {
        SqlConnection con = new SqlConnection(@"Data Source=NOTEBOOK-PC\SQLEXPRESS;Initial Catalog=QLTHUVIEN;Integrated Security=True");//biến con sqlconection để kêt nối đến CSDL
